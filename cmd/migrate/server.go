...
import (
	...
	"github.com/xwy2010/go-core/sdk"
	"github.com/xwy2010/go-core/sdk/pkg"

	"github.com/go-admin-team/go-admin-core/config/source/file"
	"github.com/spf13/cobra"

	"github.com/xwy2010/go-admin-coinhook/cmd/migrate/migration"
	_ "github.com/xwy2010/go-admin-coinhook/cmd/migrate/migration/version"
	_ "github.com/xwy2010/go-admin-coinhook/cmd/migrate/migration/version-local"
	"github.com/xwy2010/go-admin-coinhook/common/database"
	"github.com/xwy2010/go-admin-coinhook/common/models"
...
var (
	...
	StartCmd  = &cobra.Command{
		...
		Example: "coinhook migrate -c config/settings.yml",
...
func init() {
	...
	StartCmd.PersistentFlags().BoolVarP(&project, "project", "a", false, "generate project migration file")
